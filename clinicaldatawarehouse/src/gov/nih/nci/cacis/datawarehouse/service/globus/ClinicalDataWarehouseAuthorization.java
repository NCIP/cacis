 ...
 * 
 */
public class ClinicalDataWarehouseAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://datawarehouse.cacis.nci.nih.gov/ClinicalDataWarehouse";
	
	Map authorizationClassMap = new HashMap();
	
	
	public ClinicalDataWarehouseAuthorization() {
	}
	...
	public void authorizeQuery(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		...
		// authorization using method authorization from the enforce_auth extension
		((AuthorizationExtension)authorizationClassMap.get("enforce_auth")).authorizeOperation(peerSubject,context,operation);
