 ...
 * 
 */
public abstract class ClinicalDataWarehouseResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ClinicalDataWarehouseResourceBase.class);

	private ClinicalDataWarehouseResourceConfiguration configuration;
    ...
    public ClinicalDataWarehouseResourceBase() {
    }
	...
	public ClinicalDataWarehouseResourceConfiguration getConfiguration() {
		...
		servicePath+="/ClinicalDataWarehouse";
		...
		try {
			...
			this.configuration = (ClinicalDataWarehouseResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
