...
public class SampleDataGenerator {
    ...
    public static Folder createFolder(Identifiable patientID) {
        ...
        folder.getCodeList().add(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
    ...
    public static SubmissionSet createSubmissionSet(Identifiable patientID) {
        ...
        submissionSet.setContentTypeCode(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
        ...
        submissionSet.setSourceId("1.3.6.1.4.1.21367.2010.1.2.12345");
    ...
    public static DocumentEntry createDocumentEntry(Identifiable patientID) {
        ...
        docEntry.setClassCode(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
        docEntry.setComments(new LocalizedString("comment2"));
        docEntry.getConfidentialityCodes().add(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
        docEntry.setCreationTime("1981");
        docEntry.setEntryUuid("document01");
        docEntry.getEventCodeList().add(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
        ...
        docEntry.setHealthcareFacilityTypeCode(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
        ...
        docEntry.setPracticeSettingCode(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
        ...
        docEntry.setTypeCode(new Code("CDAR2/IHE 1.0", new LocalizedString("CDAR2/IHE 1.0", "en-us", "UTF-8"), "Connect-a-thon formatCodes"));
