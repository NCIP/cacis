...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:owl="http://www.w3.org/2002/07/owl#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:v3="urn:hl7-org:v3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:hl7="urn:hl7-org:functions" xmlns:DT="urn:hl7-org:v3/owl/DEFN/UV/DT/1.0#" exclude-result-prefixes="xsi xs v3 hl7">
  ...
  <xsl:template mode="ANY" match="*" as="element()*">
    <xsl:call-template name="_dispatchXSI">
      <xsl:with-param name="typeName" select="'ANY'"/>
    </xsl:call-template>
  </xsl:template>
  ...
  <xsl:template name="ED.content" as="element()*">
    ...
    <xsl:if test="self::text() or node()[not(self::v3:reference or self::v3:thumbnail)][self::* or normalize-space(.)!='']">
      <DT:ED.value>
        <xsl:call-template name="ED.value.content">
          <xsl:with-param name="content" select="self::text()|node()[not(self::v3:reference or self::v3:thumbnail)][self::* or normalize-space(.)!='']"/>
        </xsl:call-template>
      </DT:ED.value>
    </xsl:if>
    <xsl:if test="v3:reference[starts-with(@value, '#')]">
      <DT:ED.value>
        <xsl:call-template name="ED.value.content">
          <xsl:with-param name="content" select="//*[@ID=substring-after(current()/v3:reference/@value, '#')]/node()"/>
        </xsl:call-template>
      </DT:ED.value>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template mode="GTS.content" name="GTS.content" match="*" as="element()?">
    <xsl:choose>
      <xsl:when test="not(following-sibling::*[name(.)=name(current())])">
        <xsl:call-template name="_dispatchXSI">
          <xsl:with-param name="typeName" select="'GTS'"/>
        </xsl:call-template>
      </xsl:when>
  ...
  <xsl:template name="_dispatchXSI" as="element()?">
    <xsl:param name="typeName" as="xs:string" required="yes"/>
    <xsl:choose>
  ...
  <xsl:template match="/">
    <rdf:RDF xmlns:M0="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#" xmlns:_XML="http://www.w3.org/XML/1998/namespace#" xmlns:RIM="urn:hl7-org:v3/owl/DEFN/UV/RIM/207#" xmlns:DT="urn:hl7-org:v3/owl/DEFN/UV/DT/1.0#">
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ClinicalDocument.confidentialityCode"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ClinicalDocument.informationRecipient"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ClinicalDocument.legalAuthenticator"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#Organization.standardIndustryClassCode"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#OrganizationPartOf.wholeOrganization"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#LanguageCommunication.proficiencyLevelCode"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#LanguageCommunication.preferenceInd"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#AssignedAuthor.assignedAuthoringDevice"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#AssignedAuthor.assignedPerson"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#AssignedAuthor.representedOrganization"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#AuthoringDevice.manufacturerModelName"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#AssignedEntity.representedOrganization"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#AssignedCustodian.representedCustodianOrganization"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#CustodianOrganization.classCode"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#CustodianOrganization.determinerCode"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#InformationRecipient.intendedRecipient"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#IntendedRecipient.informationRecipient"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#IntendedRecipient.receivedOrganization"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#LegalAuthenticator.typeCode"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#LegalAuthenticator.contextControlCode"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#AssociatedEntity.scopingOrganization"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#EncompassingEncounter.effectiveTime"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#EncompassingEncounter.dischargeDispositionCode"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#EncompassingEncounter.responsibleParty"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#EncompassingEncounter.encounterParticipant"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#EncounterParticipant.assignedEntity"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#HealthCareFacility.serviceProviderOrganization"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubjectPerson.administrativeGenderCode"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ClinicalStatement.entryRelationship"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ObservationRange.interpretationCode"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.negationInd"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.effectiveTime"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.priorityCode"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.repeatNumber"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.routeCode"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.approachSiteCode"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.doseQuantity"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.rateQuantity"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.maxDoseQuantity"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#SubstanceAdministration.administrationUnitCode"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ManufacturedProduct.manufacturedLabeledDrug"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ManufacturedProduct.manufacturedMaterial"/>
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#ManufacturedProduct.manufacturerOrganization"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#EntryRelationship.contextConductionInd"/>
      ...
      <owl:ObjectProperty rdf:about="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#EntryRelationship.substanceAdministration"/>
  ...
  <xsl:template mode="M0_ClinicalDocument" match="*">
    <M0:ClinicalDocument xmlns:M0="urn:hl7-org:v3/owl/DEFN/UV/CD/MT/000040#" rdf:parseType="Resource">
